                        ...
                        <form id="subsidiary-label" name="contentForm"  role="form" data-toggle="validator" novalidate="true">
                            <div class="form schedule-assessment">
                                <div class="row  margin-top-l">
                                                    ...
                                                    <table id="label-koma" class="afternoon-session blind-main" cellspacing="1">
                                                        ...
                                                        <tbody>
                                                            <tr >
                                                                <td>
                                                                    <label>
                                                                        <select id="select_koma" class="label_select" data-id="koma_label_img">
                                                    ...
                                                    <table id="label-main" class="afternoon-session blind-main" cellspacing="1">
                                                        ...
                                                        <tbody>
                                                            <tr >
                                                                ...
                                                                <td class="label_img" style="display: none">
                                                                    <select id="select_main" class="label_select" data-id="main_label_img" disabled>
                                                                        <option value="">선택</option>
                                                                    </select>
                                    ...
                                    <p class="sub-title-2" onClick="javascript:addSubsidiary();">
                                        <img src="images/plus.png">추가하기
                                    </p>    
                                    <p class="sub-p">
            ...
            <section>
                <div class="processing_m">
                    <form id="manufacturing_form">
                        ...
                        <!-- <div class="file_load process_g ">
                            <p>
                                <label for="image" class="s-title">2.가공 이미지 파일 업로드</label>
                                <br />
                                <input type="file" name="manufacturing_img" id="manufacturing_img" class="file_img"/>
                            </p>
                            <div id="image_preview" class="img_view">
                                <img src="#" />
                                <br />
                            ...
                            <p class="ex">&ast;나염, DTG : 가로 2500px이상 , 배경 투명, 상하좌우없이 꽉 채운 이미지<br>
                                전사, 자수: AI(일러스트)확장된 형식의 이미지</p>
                        </div> -->
                        
                        <div class="position process_g" style="display: none;">
                        ...
                        &ast;가공을 원하시는 위치가 많은 경우 상담문의를 해주세요</p>
                            <div id="front" class="img-wrapper">
                                ...
                                <img id="front-canvas-img" class="bkg" src="" style="display: none;">
                                <input type="file" id="front-upload" class="bkg-file" data-id="front-canvas"/>
                                <br>
                                ...
                                <input type="hidden" id="front-scaleX" class="scaleX" data-id="front-canvas" value=""/>
                                <input type="hidden" id="front-scaleY" class="scaleY" data-id="front-canvas" value=""/>
                                <input type="hidden" id="front-angle" class="angle" data-id="front-canvas" value=""/>
                            </div>
                            <div id="back" class="img-wrapper">
                                ...
                                <img id="back-canvas-img" class="bkg" src="" style="display: none;">
                                <input type="file" id="back-upload" class="bkg-file" data-id="back-canvas"/>
                                <br>
                                ...
                                <input type="hidden" id="back-scaleX" class="scaleX" data-id="back-canvas" value=""/>
                                <input type="hidden" id="back-scaleY" class="scaleY" data-id="back-canvas" value=""/>
                                <input type="hidden" id="back-angle" class="angle" data-id="back-canvas" value=""/>
                            </div>
                            <div id="left" class="img-wrapper">
                                ...
                                <img id="left-canvas-img" class="bkg" src="" style="display: none;">
                                <input type="file" id="left-upload" class="bkg-file" data-id="left-canvas"/>
                                <br>
                                ...
                                <input type="hidden" id="left-scaleX" class="scaleX" data-id="left-canvas" value=""/>
                                <input type="hidden" id="left-scaleY" class="scaleY" data-id="left-canvas" value=""/>
                                <input type="hidden" id="left-angle" class="angle" data-id="left-canvas" value=""/>
                            </div>
                            <div id="right" calss="img-wrapper">
                                ...
                                <img id="back-canvas-img" class="bkg" src="" style="display: none;">
                                <input type="file" id="right-upload" class="bkg-file" data-id="right-canvas"/>
                                <br>
                                ...
                                <input type="hidden" id="right-scaleX" class="scaleX" data-id="right-canvas" value=""/>
                                <input type="hidden" id="right-scaleY" class="scaleY" data-id="right-canvas" value=""/>
                                <input type="hidden" id="right-angle" class="angle" data-id="right-canvas" value=""/>
                            </div>
                        </div>
            ...
            if(formula == "per") {
                $('.grading_w').each(function(id, item) {
                    $(this).find('.after').each(function() {        
                        ...
                        index = ($(this).parents('.grading_w').index() > 3) ? 6 : 0;
