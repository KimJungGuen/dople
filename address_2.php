...
<html lang="ko">
  <head>
    ...
    <link href="css/address_2.css" rel="stylesheet" type="text/css">
    ...
    <?php
    session_start();
    if($_SESSION['userNumber'] || $_COOKIE['userNumber']) {
            ...
            <div class="container">
              <div class="row">
                <div class="col-xs-12 text-center">
                  <h2 id="h2">주소관리 <p class="position">-주소수정</p></h2>
                </div>
              </div>          
              <div class="row">
                  ...
                  <div class="form schedule-assessment">
                    ...
                    <div class="add">
                          ...
                          <div class="form-group col-md-12 text-center">
                                  ...
                                  <input name="post_1" id="post_1" class="input_filed" placeholder="" type="text" required readOnly data-error="주소찾기를 해주세요"><br>
                                  <label for="post_2" class="login daddress">상세주소</label><br>
                                  <input name="post_2" id="post_2" class="input_filed" placeholder="" type="text" data-error="">
                                  <div class="help-block with-errors"></div>
                          </div>
                          <div class="form-group col-md-12 text-center">
                                  <label for="name" class="login get">받는사람</label><br>
                                  <input name="name" id="name" class="input_filed" placeholder="" type="text" data-error="받는사람을 입력해주세요." required>
                                  <div class="help-block with-errors"></div>
                          </div> 
