<?php
    ...
    if(empty($_SESSION['adminName']) && empty($_COOKIE['adminName'])) {
        echo "<script>document.location.href='user-login.php'</script>";
    }
?>
                            ...
                            <ul class="list-inline mb-0">
                                ...
                                <li class="list-inline-item">
                                    <div class="profilebar">
                                        <div class="dropdown">
                                            <?php session_start(); ?>
                                            <?php if(empty($_SESSION['adminName']) && empty($_COOKIE['adminName'])) { ?>
                                                <a class="dropdown-toggle" href="user-login.php"><span class="live-icon">Login</span></span></a>
                                            <?php } else { ?>
                                                <a class="dropdown-toggle" href="#" role="button" id="profilelink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="assets/images/users/profile.svg" class="img-fluid" alt="profile"><span class="live-icon"><?php echo $_SESSION['adminName'] ?></span><span class="feather icon-chevron-down live-icon"></span></a>
                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="profilelink">
                                                        ...
                                                        <div class="userbox">
                                                            <ul class="list-unstyled mb-0">
                                                                ...
                                                                <li class="media dropdown-item">
                                                                    <a id="logout" onClick="javascript:logout();" class="profile-icon"><img src="assets/images/svg-icon/logout.svg" class="img-fluid" alt="logout">Logout</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
            ...
            <script>
                function logout() {
                    $.ajax({
                        ...
                        type: 'delete',
                        success: function() {
                            location.href = "https://www.madclother.com/dev/root/";
                        }
                    });
                }
            </script>