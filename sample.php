...
<body style="overflow: auto;">
                                ...
                                <?php foreach($order as $row) { ?> 
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php } else if($row['order_status'] == '결제대기중') {?>
                                                <form class="order_buy" name="order_buy" method="post" action="">
                                                    <input type="hidden" name="order_number" value="<?=$row['order_number']?>">
                                                    <button class="bt bt-3" value="<?php echo $row['order_consent']; ?>">결제</button>
                                                </form>
    ...
    <script>
        ...
        */
        ...
        $(document).on('submit', '.order_buy', function() {
            if($(this).find('button').val() != 1) {
                $(this).attr("action", "electronic.php");
            } else {
                $(this).attr("action", "payment.php");  
            }
        });
